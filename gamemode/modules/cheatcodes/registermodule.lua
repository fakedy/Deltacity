...
local folderName = "cheatcodes"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "Fakedy","description": "Cheat Codes","website": "nowebsite.com","version": "0.1", "blacklistedFiles": ["sv_testfile.lua"], "networkStrings": ["networkString1", "networkString2"], "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'
