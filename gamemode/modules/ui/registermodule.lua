...
local folderName = "ui"
local moduleData = '{"folderName": "' .. folderName .. '", "loadPriority": 5,"author": "Fakedy","description": "UI module","website": "alydus.net","version": "0.1", "blacklistedFiles": ["sv_testfile.lua"], "networkStrings": ["networkString1", "networkString2"], "loadPrefixes": {"server": "sv_", "client": "cl_", "shared": "sh_"}}'
